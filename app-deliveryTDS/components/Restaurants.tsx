...
const restaurants: Restaurant[] = [
  ...
  },
  {
    name: 'Sushi do Mufas',
    rating: 4.7,
    image: 'https://png.pngtree.com/png-vector/20240910/ourmid/pngtree-cute-cartoon-lion-cub-sitting-clipart-illustration-digital-png-image_13805459.png',
    distance: '1.5 km',
  },
  {
    name: 'Burguer do Tomás',
    rating: 0.5,
    image: 'https://guiadoestudante.abril.com.br/wp-content/uploads/sites/4/2021/04/EACCD5bXYAAHHC2-e1617323117215.jpeg?quality=70&strip=info&w=414&h=280&crop=1',
    distance: '3 km',
  },
];
    ...
    <View style={styles.restaurants}>
      ...
      {restaurants.map((restaurant, index) => {
        ...
        if (restaurant.name === 'Pizzaria da 232N') {
         ...
         if (restaurant.name === 'Sushi do Mufas') {
          // Verifica se o restaurante é a pizzaria específica para aplicar navegação.
        ...
        if (restaurant.name === 'Burguer do Tomás') {
          // Verifica se o restaurante é a pizzaria específica para aplicar navegação.

          return (
            <Link href="/(tabs)/screens/burguertomas" asChild key={index}>
              {/* Envolve o botão com Link para navegar para a tela da pizzaria. */}
              <TouchableOpacity>{cardContent}</TouchableOpacity>
            </Link>
          );
